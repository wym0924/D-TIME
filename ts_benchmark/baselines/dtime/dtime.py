...
from ts_benchmark.baselines.dtime.utils.tools import EarlyStopping, adjust_learning_rate
...
from ts_benchmark.baselines.dtime.models.dtime_model import DTIMEModel
...
class DTIME(ModelBase):
    ...
    def forecast_fit(self, train_valid_data: pd.DataFrame, train_ratio_in_tv: float) -> "ModelBase":
        ...
        self.model = DTIMEModel(self.config)
